  ...
  <header class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-3">
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center gap-3">
        ...
        <button on:click={() => showSettings = true} aria-label="Pengaturan" class="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <button on:click={handleLogout} aria-label="Keluar" class="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg text-red-500">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
